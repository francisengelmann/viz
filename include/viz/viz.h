...
public:
  ...
  void addAxes();
  void addAxesBig();
  /*void addSegment(const Eigen::Vector3d start,
  ...
  void addPointcloud(const std::shared_ptr<viz::Pointcloud>& pointcloud, double point_size = 3);
  void addPointcloud(const viz::Pointcloud& pointcloud, double point_size = 3);
  ...
  //void addAnnotation(const gvl::Annotation& annotation,
